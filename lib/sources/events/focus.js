...
goog.provide( 'zz.controllers.events.Focus' );
goog.require( 'zz.events.BaseEvent' );
goog.require( 'zz.controllers.enums.EventType' );

/**
 * Controller focus event class.
 * @param {Object} node
 * @extends {zz.events.BaseEvent}
 * @constructor
 */
zz.controllers.events.Focus = function( node ){

	goog.base( this, zz.controllers.enums.EventType.FOCUS );
...
goog.inherits( zz.controllers.events.Focus, zz.events.BaseEvent );