...
goog.provide( 'zz.controllers.events.Leave' );
goog.require( 'zz.events.BaseEvent' );
goog.require( 'zz.controllers.enums.EventType' );

/**
 * Controller leave event class.
 * @param {Object} node
 * @extends {zz.events.BaseEvent}
 * @constructor
 */
zz.controllers.events.Leave = function( node ){

	goog.base( this, zz.controllers.enums.EventType.LEAVE );
...
goog.inherits( zz.controllers.events.Leave, zz.events.BaseEvent );