...
zz.controllers.FEBase.prototype.disposeInternal = function( ){
    ...
    var datarow = this.model_.firstDatarow( );
    while( datarow ){

        this.render_.removeDatarowInterface( this.model_, datarow );
        datarow = this.model_.nextDatarow( );
    }
    this.render_.removeElement( this.model_.getUid( ) );
